  ...
  return (
    <div>
      ...
      <Container className='flex min-h-screen max-w-full flex-col items-center justify-center gap-14 bg-base-100 px-10'>
        ...
        <div className='mx-auto flex items-start justify-center gap-8 md:w-2/3'>
          <div className='flex h-fit w-2/3 flex-col justify-between rounded-md bg-amber-100 px-8 py-4 md:h-72 lg:h-56'>
            <div>
            ...
            <Link
              href={'/admin'}
              className='mt-6 rounded-md bg-primary px-4 py-2 text-center text-white'>
              Go to admin
            </Link>
          </div>
          <div className='flex h-fit w-2/3 flex-col justify-between rounded-md bg-orange-100 px-8 py-4 md:h-72 lg:h-56'>
            ...
            <button
              className='z-50 mt-6 cursor-pointer rounded-md bg-primary px-4 py-2 text-center text-white'
