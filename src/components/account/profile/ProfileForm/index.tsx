        ...
        <div className='mx-auto mt-8 grid'>
          ...
          <form
            ...
            <div className='flex justify-end'>
              <button
                type='submit'
                className='w-full rounded-full  bg-primary px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-[#805AE9] focus:outline-none focus:ring-4 focus:ring-primary/30 sm:w-auto'>
