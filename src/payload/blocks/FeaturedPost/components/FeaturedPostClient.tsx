...
import { Blog, FeaturedPostType, Media, Tag, User } from '@payload-types'
import Image from 'next/image'
import Link from 'next/link'

const FeaturedPostClient: React.FC<{
  block: FeaturedPostType
...
export default FeaturedPostClient
